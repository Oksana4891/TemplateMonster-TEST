...
window.onload = function () {
  ...
  function slider(sliderItemSelector, sliderSwitchSelector) {
    var slides = document.querySelectorAll(sliderItemSelector),
  ...
  function accordion(triggersSelector, selectorBlock) {
    ...
    var block = document.querySelectorAll(selectorBlock);
  ...
  function modalVideoPlayer(triggersSelector, modalSelector, closeSelector) {
    var modalOpen = document.querySelector(triggersSelector),
  ...
  function parallaxes(selectorParallaxes, selectorContainer) {
    var parallaxesElement = document.querySelector(selectorParallaxes);
    var boxContainer = document.querySelector(selectorContainer);
    var centerX = parallaxesElement.offsetLeft + parallaxesElement.offsetWidth / 2;
    var centerY = parallaxesElement.offsetTop + parallaxesElement.offsetHeight / 2;

    function getMousePos(xRef, yRef) {
      var panelRect = boxContainer.getBoundingClientRect();
      return {
